...
solution "ld46"
    ...
    configuration {"web"}
        ...
        buildoptions
        {
            "-DorxWEB_EXECUTABLE_NAME='\"RailroadLantern.wasm\"'",
            "-pthread"
        }
        linkoptions
        {
            "--preload-file " .. copybase .. "/build/RailroadLantern.obr@/",
    ...
    configuration {"web", "Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && RailroadLantern -b ../build/RailroadLantern.obr"}
        postbuildcommands {"del " .. path.translate(copybase, "\\") .. "\\build\\RailroadLantern.obr"}

    configuration {"web", "not Windows"}
        prelinkcommands {"cd " .. copybase .. "/bin && ./RailroadLantern -b ../build/RailroadLantern.obr"}
        postbuildcommands {"rm " .. copybase .. "/build/RailroadLantern.obr"}
...
project "RailroadLantern"
    ...
    configuration {"*Bundle*", "not web"}
        debugargs {"-b", "RailroadLantern.obr"}
